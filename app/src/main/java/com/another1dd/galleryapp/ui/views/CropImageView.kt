...
import com.another1dd.galleryapp.utils.redactor.CubicEasing
...
import com.another1dd.galleryapp.utils.redactor.task.BitmapCropTask
...
open class CropImageView : TransformImageView {
     ...
     */
    fun setMaxResultImageSizeX(maxResultImageSizeX: Int) {
     ...
     */
    fun setMaxResultImageSizeY(maxResultImageSizeY: Int) {
     ...
     */
    fun setImageToWrapCropBoundsAnimDuration(imageToWrapCropBoundsAnimDuration: Long) {
    ...
    protected fun zoomImageToPosition(scale: Float, centerX: Float, centerY: Float, durationMs: Long) {
        var scaleNew = scale
        if (scaleNew > maxScale) {
            scaleNew = maxScale
        }

        val oldScale = currentScale
        val deltaScale = scaleNew - oldScale
